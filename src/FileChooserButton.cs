namespace Banshee {
	...
	public  class FileChooserButton : Gtk.HBox, Gtk.FileChooser {
		...
		[GLib.DefaultSignalHandler(Type=typeof(Banshee.FileChooserButton), ConnectionMethod="OverrideSelectionChanged")]
		...
		[GLib.DefaultSignalHandler(Type=typeof(Banshee.FileChooserButton), ConnectionMethod="OverrideFileActivated")]
		...
		[GLib.DefaultSignalHandler(Type=typeof(Banshee.FileChooserButton), ConnectionMethod="OverrideUpdatePreview")]
		...
		[GLib.DefaultSignalHandler(Type=typeof(Banshee.FileChooserButton), ConnectionMethod="OverrideCurrentFolderChanged")]
