...
public  class ContentDescriptor : IComparable {
    ...
    /**
     * Constant for the content descriptor-type for bools.
     */
     ...
     * 
     * @return bool representation of the current value.
     */
