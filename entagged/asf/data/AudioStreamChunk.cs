 ...
 */
public class AudioStreamChunk : StreamChunk {

    /**
     * Stores the hex values of codec identifiers to their descriptions. <br>
     */
    public  static string[][] CODEC_DESCRIPTIONS = {
     ...
     */
    public AudioStreamChunk(long pos, ulong chunkLen) {
        super(pos, chunkLen);
    }
