...
public class GUID {
     ...
     */
    public  static GUID GUID_AUDIO_ERROR_CONCEALEMENT_ABSENT = new GUID(
     ...
     * concealment. <br>
     */
    public  static GUID GUID_AUDIO_ERROR_CONCEALEMENT_INTERLEAVED = new GUID(
            new int[] { 0x40, 0xA4, 0xF1, 0x49, 0xCE, 0x4E, 0xD0, 0x11, 0xA3,
                    0xAC, 0x00, 0xA0, 0xC9, 0x03, 0x48, 0xF6 },
     ...
     */
    public  static GUID GUID_AUDIOSTREAM = new GUID(new int[] { 0x40,
     ...
     */
    public  static GUID GUID_CONTENTDESCRIPTION = new GUID(new int[] {
     ...
     */
    public  static GUID GUID_ENCODING = new GUID(new int[] { 0x40, 0x52,
     ...
     * chunk. <br>
     */
    public  static GUID GUID_EXTENDED_CONTENT_DESCRIPTION = new GUID(
     ...
     */
    public  static GUID GUID_FILE = new GUID(new int[] { 0xA1, 0xDC, 0xAB,
     ...
     */
    public  static GUID GUID_HEADER = new GUID(new int[] { 0x30, 0x26,
     ...
     */
    public  static int GUID_LENGTH = 16;

    /**
     * This constant stores the GUID indicating a stream object.
     */
    public  static GUID GUID_STREAM = new GUID(new int[] { 0x91, 0x07,
     ...
     */
    public  static GUID GUID_UNKNOWN_1 = new GUID(new int[] { 0xB5, 0x03,
     ...
     * This constant stores a GUID whose functionality is unknown.
     */
    public  static GUID GUID_UNKNOWN_2 = new GUID(new int[] { 0xCE, 0x75,
     ...
     */
    public  static GUID GUID_VIDEOSTREAM = new GUID(new int[] { 0xC0,
     ...
     */
    public  static GUID[] KNOWN_GUIDS = new GUID[] {
     ...
     */
    public static bool assertGUID(int[] value) {
        bool result = false;
        if (value != null) {
