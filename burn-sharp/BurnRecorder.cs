...
#region Autogenerated code
	public  class BurnRecorder : GLib.Object {
		...
		[GLib.CDeclCallback]
		delegate void ProgressChangedSignalDelegate (IntPtr arg0, double arg1, IntPtr gch);

		static void ProgressChangedSignalCallback (IntPtr arg0, double arg1, IntPtr gch)
		{
		...
		[GLib.CDeclCallback]
		delegate void ProgressChangedVMDelegate (IntPtr recorder, double fraction);

		static ProgressChangedVMDelegate ProgressChangedVMCallback;

		static void progresschanged_cb (IntPtr recorder, double fraction)
		{
			BurnRecorder obj = GLib.Object.GetObject (recorder, false) as BurnRecorder;
			obj.OnProgressChanged (fraction);
		}
		...
		protected virtual void OnProgressChanged (double fraction)
		{
