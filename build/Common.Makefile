...
## Running ##
RUN_PATH = \
	LD_LIBRARY_PATH=$(top_builddir)/libbanshee/.libs DYLD_LIBRARY_PATH=$${LD_LIBRARY_PATH} MONO_PATH=$(DIR_HAL):$(DIR_TAGLIB):$(DIR_DBUS):$(DIR_LAST_FM):$(DIR_MUSICBRAINZ):$(DIR_GNOME_KEYRING):$(DIR_BANSHEE_WIDGETS):$(DIR_BANSHEE_BASE)$${MONO_PATH+:$$MONO_PATH} \
